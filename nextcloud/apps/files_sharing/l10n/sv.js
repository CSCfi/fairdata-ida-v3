OC.L10N.register(
    ...
    "Use the credentials below to configure your remote client. For security reasons this password will only be shown once." : "Använd inloggningsuppgifterna nedan för att konfigurera din fjärrklient. Av säkerhetsskäl visas detta lösenord bara en gång.",
    "Only works for users with access to this folder" : "Fungerar endast för användare med åtkomst till den här mappen",
    "Only works for users with access to this file" : "Fungerar endast för användare med åtkomst till den här filen",
    "Use this method to share files with your CSC Project members. If the recipient already has access to the share but cannot locate it, you can send them the internal share link for easy access." : "Använd den här metoden för att dela filer med medlemmarna i ditt CSC-projekt. Om mottagaren redan har åtkomst till delningen men inte kan hitta den kan du skicka den interna delningslänken för enkel åtkomst.",
    "Use this method to share files with individuals outside your CSC Project. Files and folders can be shared via public share links." : "Använd den här metoden för att dela filer med personer utanför ditt CSC-projekt. Filer och mappar kan delas via offentliga delningslänkar.",
