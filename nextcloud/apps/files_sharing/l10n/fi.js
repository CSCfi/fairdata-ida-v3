OC.L10N.register(
    ...
    "Use the credentials below to configure your remote client. For security reasons this password will only be shown once." : "Käytä alla olevia tunnuksia etäasiakasohjelman määrittämiseen. Turvallisuussyistä tämä salasana näytetään vain kerran.",
    "Only works for users with access to this file" : "Toimii ainoastaan käyttäjille joilla on pääsy tähän tiedostoon",
    "Only works for users with access to this folder" : "Toimii ainoastaan käyttäjille joilla on pääsy tähän kansioon",
    "Use this method to share files with your CSC Project members. If the recipient already has access to the share but cannot locate it, you can send them the internal share link for easy access." : "Käytä tätä menetelmää tiedostojen jakamiseen CSC-projektisi jäsenien kanssa. Jos vastaanottajalla on jo pääsy jaettuun tiedostoon, mutta hän ei löydä sitä, voit lähettää hänelle sisäisen jakolinkin.",
    "Use this method to share files with individuals outside your CSC Project. Files and folders can be shared via public share links." : "Käytä tätä menetelmää tiedostojen jakamiseen CSC-projektisi ulkopuolisten henkilöiden kanssa. Tiedostoja ja kansioita voidaan jakaa julkisten jakolinkkien kautta.",
