...
class File extends Node implements IFile {
	...
	public function put($data) {
        ...
        if (class_exists('\OCA\IDA\Controller\DataChangeController')) {
            try {
                \OCA\IDA\Controller\DataChangeController::processNextcloudOperation('add', $this->path, null, $this->idaUser, $this->idaMode, "WebDAV::put");
            } catch (\Throwable $e) { 
                ; // TODO log error
            }
        }
	...
	public function delete() {
        ...
        if (class_exists('\OCA\IDA\Controller\DataChangeController')) {
            try {
                \OCA\IDA\Controller\DataChangeController::processNextcloudOperation('delete', $this->path, null, $this->idaUser, $this->idaMode, "WebDAV::delete");
            } catch (\Throwable $e) { 
                ; // TODO log error
            }
        }
