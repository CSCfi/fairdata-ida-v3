...
return [
    ...
    // All routes except those used for UI, which are defined using Vue conventions
    ...
    'routes' => [
        ...
        [
            ...
            //     projects = zero or more projects, comma separated, with no whitespace
        ],
        [
        ...
        [
            ...
            // and frozen areas, with all technical metadata about each file. If a pathname is
            // specified, returns full inventory details only of that specific node.
        ...
        [
            // Return inventory details of a specific project file stored in the IDA service, whether in staging
            // or frozen area, with all technical metadata about each file.
            'name' => 'Freezing#getFileDetails',
            'url'  => '/api/inventory/file/{project}',
            'verb' => 'GET'
            // Restricted to project access scope of user
            // Required parameters:
            //     project = the name of the project
            //     pathname = pathname of a specific node, including staging or frozen root folder
        ],
        ...
        [
            ...
            'name' => 'FrozenFile#getFileByNextcloudNodeId',
        ...
        [
            ...
            // (this path pattern is ugly, but it's only used by the UI and it works, so...)
            'name' => 'FrozenFile#getFileByProjectPathname',
        ...
        [
            ...
            'name' => 'FrozenFile#setProjectTitle',
            'url'  => '/api/setProjectTitle',
            'verb' => 'POST'
            // Restricted to admin or PSO user of specified project
            // Required parameters:
            //    project = the name of the project
        ...
        [
            // Retrieve project title, if defined
            'name' => 'FrozenFile#getProjectTitle',
