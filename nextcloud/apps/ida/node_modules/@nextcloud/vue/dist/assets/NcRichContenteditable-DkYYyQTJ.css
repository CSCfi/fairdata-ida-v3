...
* Ensure proper alignment of the vue material icons
*/
.material-design-icon[data-v-81c31f7c] {
  display: flex;
  align-self: center;
  justify-self: center;
  align-items: center;
...
.rich-contenteditable[data-v-81c31f7c] {
  position: relative;
  width: auto;
}
.rich-contenteditable__label[data-v-81c31f7c] {
  position: absolute;
...
.rich-contenteditable__input:focus + .rich-contenteditable__label[data-v-81c31f7c], .rich-contenteditable__input:not(.rich-contenteditable__input--empty) + .rich-contenteditable__label[data-v-81c31f7c] {
...
.rich-contenteditable__input[data-v-81c31f7c] {
  overflow-y: auto;
  width: auto;
  margin: 0;
  padding: 8px;
...
.rich-contenteditable__input--has-label[data-v-81c31f7c] {
  margin-top: 10px;
}
.rich-contenteditable__input--empty[data-v-81c31f7c]:focus:before, .rich-contenteditable__input--empty[data-v-81c31f7c]:not(.rich-contenteditable__input--has-label):before {
  content: attr(aria-placeholder);
  color: var(--color-text-maxcontrast);
  position: absolute;
}
.rich-contenteditable__input[contenteditable=false][data-v-81c31f7c]:not(.rich-contenteditable__input--disabled) {
  cursor: default;
  background-color: transparent;
  color: var(--color-main-text);
...
.rich-contenteditable__input--multiline[data-v-81c31f7c] {
  min-height: calc(var(--default-clickable-area) * 3);
  max-height: none;
}
.rich-contenteditable__input--disabled[data-v-81c31f7c] {
  opacity: 0.5;
  color: var(--color-text-maxcontrast);
