require('../assets/NcRichText-BlRmdWCX.css');
"use strict";
...
const referencePickerModal = require("./referencePickerModal-C4eGo6D2.cjs");
...
const NcCheckboxRadioSwitch = require("./NcCheckboxRadioSwitch-DdquK4fW.cjs");
...
const _sfc_main = {
  ...
  methods: {
    ...
    renderMarkdown(h) {
      ...
      }).use(this.useExtendedMarkdown ? remarkGfm__default.default : void 0).use(breaks__default.default).use(remark2rehype__default.default, {
        handlers: {
          component(toHast, node) {
            return toHast(node, node.component, { value: node.value });
          }
        }
      }).use(this.useExtendedMarkdown && rehypeHighlightLoaded.value ? rehypeHighlight : void 0).use(remarkPlaceholder).use(rehypeExternalLinks__default.default, {
        target: "_blank",
