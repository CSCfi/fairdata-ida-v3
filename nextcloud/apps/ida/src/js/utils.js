...
export const getNodeDetails = (pathname) => {
    ...
    try {
        console.debug('Fetching node details for ' + pathname + ' ...');
        ...
        if (xhr.status === 200) {
            ...
            console.debug('Node details retrieved for ' + pathname + ' successfully.');
            return data;
        }
        if (xhr.status === 404) {
            console.debug('Node details for ' + pathname + ' not found.');
            return null;
        }
