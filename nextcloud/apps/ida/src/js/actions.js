...
function showActionDialog(action, node) {
    ...
    const title = t('ida', capitalize(action)) + ' ' + t('ida', capitalize(node.type)) + '?';
...
function handleActionSuccess(action, data) {
    ...
    if (action === 'freeze') {
        ...
        modalTitle.textContent = t('ida', 'Action initiated successfully. Show frozen data?');
        modalContent.innerHTML = t('ida', 'The data has been successfully frozen and moved to the frozen project space.') + ' '
        ...
        modalTitle.textContent = t('ida', 'Action initiated successfully. Show unfrozen data?');
        modalContent.innerHTML = t('ida', 'The data has been successfully unfrozen and moved back to the project staging space.') + ' '
                                     + t('ida', 'Depending on the amount of data, the background operations may still take several hours.') + ' '
                                     + t('ida', 'The initiated action is') + ' '
                                     + '<a style="color: #007FAD;" href="/apps/ida/action/' + data.pid + '">' + data.pid + '</a>.' + ' '
        ...
        modalTitle.textContent = t('ida', 'Action initiated successfully. Files deleted.');
        modalContent.innerHTML = t('ida', 'The files have been successfully deleted.') + ' '
                                     + t('ida', 'Depending on the amount of data, the background operations may still take several hours.') + ' '
                                     + t('ida', 'The initiated action is') + ' '
                                     + '<a style="color: #007FAD;" href="/apps/ida/action/' + data.pid + '">' + data.pid + '</a>.';
        cancelButton.textContent = t('ida', 'OK');
