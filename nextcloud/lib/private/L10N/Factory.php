...
class Factory implements IFactory {
        ...
        if ($hostname) {
            ...
            if (isset($_COOKIE[$cookie])) {
                try {
                    ...
                    logger('ida')->error('base.php: handleLogin: JWT decode failed: ' . $e->getMessage());
                    $session = null;
                }
	...
	public function findGenericLanguage(?string $appId = null): string {
        ...
        // IDA MODIFICATION START
        // TODO Check if we need to modify this to get language from Fairdata SSO session, etc.
        // IDA MODIFICATION END
