...
class Constants {
    ...
    // NC31 introduced more variability in token lengths, which we don't need and breaks things
    // in the IDA modifications, so we explicitly force them all to be 12 per the previous default
	...
	public const MIN_TOKEN_LENGTH = 12;
	public const DEFAULT_TOKEN_LENGTH = 12;
