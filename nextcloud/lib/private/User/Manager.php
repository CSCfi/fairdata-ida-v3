...
class Manager extends PublicEmitter implements IUserManager {
	...
	public function validateUserId(string $uid, bool $checkDataDirectory = false): void {
		...
		// The ida_project script creates and initializes the project share owner users' home folder, so it
		// will exist when this test is done, so only do the final test for non-PSO users
		if (str_starts_with($uid, 'PSO_')) {
            return;
        }
