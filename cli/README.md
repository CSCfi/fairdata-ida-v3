...
To create an application password, log in to the IDA web UI, and open the security settings view by selecting "Security"
from the pull down settings menu at the top right of the view.
