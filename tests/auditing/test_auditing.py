...
class TestAuditing(unittest.TestCase):
    ...
    def setUp(self):
        ...
        cmd = "DEBUG=false %s/appsupport/list-missing-checksums test_project_a" % (self.config["ROOT"])
        try:
    ...
    def test_auditing(self):
        ...
        try:
            path.mkdir()
            #shutil.chown(pathname, user='apache', group='apache')
        except Exception as error:
        ...
        cmd = "DEBUG=false %s/appsupport/list-active-projects %s" % (self.config["ROOT"], self.config["START"])
        try:
        ...
        cmd = "DEBUG=false %s/appsupport/audit-active-projects %s" % (self.config["ROOT"], self.config["START"])
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding)
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/list-active-projects %s" % (self.config["ROOT"], self.config["INITIALIZED"])
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding)
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/list-active-projects %s" % (self.config["ROOT"], self.config["MODIFIED"])
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding)
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/check-datasets-pre-repair %s" % (self.config["ROOT"], report_pathname_a)
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding).strip()
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/fetch-dataset-in-metax %s" % (self.config["ROOT"], dataset_pid)
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding).strip()
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/repair-project %s --force" % (self.config["ROOT"], report_pathname_a)
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding).strip()
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/repair-project %s" % (self.config["ROOT"], report_pathname_b)
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding).strip()
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/repair-project %s" % (self.config["ROOT"], report_pathname_c)
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding).strip()
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/repair-project %s" % (self.config["ROOT"], report_pathname_d)
        ...
        cmd = "DEBUG=false %s/appsupport/repair-project test_project_d" % self.config["ROOT"]
        failed = False
        try:
            output = subprocess.check_output(cmd, shell=True, stderr=subprocess.STDOUT).decode(sys.stdout.encoding)
        except subprocess.CalledProcessError as error:
        ...
        print("(repairing project D)")
        cmd = "DEBUG=false %s/appsupport/repair-project test_project_d --force" % self.config["ROOT"]
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding).strip()
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/mark-action-as-cleared test_project_a %s" % (self.config["ROOT"], action['pid'])
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding).strip()
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/repair-project %s" % (self.config["ROOT"], report_pathname)
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding).strip()
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/repair-project test_project_e --force" % self.config["ROOT"]
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding).strip()
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
        ...
        cmd = "DEBUG=false %s/appsupport/repair-project %s" % (self.config["ROOT"], report_pathname_e)
        try:
            output = subprocess.check_output(cmd, stderr=subprocess.STDOUT, shell=True).decode(sys.stdout.encoding).strip()
        except subprocess.CalledProcessError as error:
            self.fail(error.output.decode(sys.stdout.encoding))
