...
class TestAuditing(unittest.TestCase):
    ...
    def test_auditing(self):
        ...
        self.assertEqual(report_data.get("nextcloudNodeCount"), 124)
        ...
        print("Verify correct number of reported filesystem nodes")
        self.assertEqual(report_data.get("filesystemNodeCount"), 124)
        ...
        print("Verify correct number of reported filesystem nodes")
        self.assertEqual(report_data.get("filesystemNodeCount"), 121)
        ...
        print("Verify correct number of reported filesystem nodes")
        self.assertEqual(report_data.get("filesystemNodeCount"), 125)

        print("Verify correct number of reported Nextcloud nodes")
        self.assertEqual(report_data.get("nextcloudNodeCount"), 125)
        ...
        print("Verify correct number of reported Nextcloud nodes")
        self.assertEqual(report_data.get("nextcloudNodeCount"), 121)
        ...
        #print("Metax frozen file PIDs 2: %s" % json.dumps(metax_file_pids_2))
        #print("Metax frozen file PID count 2: %d" % len(metax_file_pids_2))
        self.assertEqual(len(frozen_file_pids_2), 90)
        self.assertEqual(len(metax_file_pids_2), 90)
        ...
        #print("Metax frozen file diff 2v1: %s" % json.dumps(metax_file_pid_diff_2v1))
        self.assertEqual(len(frozen_file_pid_diff_1v2), 0)
        self.assertEqual(len(frozen_file_pid_diff_2v1), 90)
        self.assertEqual(len(metax_file_pid_diff_1v2), 0)
        self.assertEqual(len(metax_file_pid_diff_2v1), 90)
        ...
        #print("Metax frozen file PIDs 3: %s" % json.dumps(metax_file_pids_3))
        #print("Metax frozen file PID count 3: %d" % len(metax_file_pids_3))
        self.assertEqual(len(frozen_file_pids_3), 63)
        self.assertEqual(len(metax_file_pids_3), 90)
        ...
        self.assertEqual(len(frozen_file_pids_4), 63)
        self.assertEqual(len(metax_file_pids_4), 63)
        ...
        self.assertEqual(len(frozen_file_pids_5), 90)
        self.assertEqual(len(metax_file_pids_5), 90)
        ...
        self.assertEqual(len(frozen_file_pids_6), 63)
        self.assertEqual(len(metax_file_pids_6), 90)
        ...
        print("Verify correct number of reported IDA frozen files")
        self.assertEqual(report_data.get("frozenFileCount"), 63)

        print("Verify correct number of reported Metax files")
        self.assertEqual(report_data.get("metaxFileCount"), 90)
