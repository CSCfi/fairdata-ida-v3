...
class TestOldData(unittest.TestCase):
    ...
    def test_olddata(self):
        ...
        self.assertEqual(report_data.get('totalFiles'), 77)
        self.assertEqual(report_data.get('totalBytes'), 135088)
        self.assertEqual(report_data.get('totalFrozenFiles'), 13)
        self.assertEqual(report_data.get('totalFrozenBytes'), 23040)
        self.assertEqual(report_data.get('totalStagingFiles'), 64)
        self.assertEqual(report_data.get('totalStagingBytes'), 112048)
        ...
        self.assertEqual(len(stagingFiles), 64)
        ...
        self.assertEqual(report_data.get('maxDataAgeInDays'), 0)
        self.assertEqual(report_data.get('totalFiles'), 167)
        self.assertEqual(report_data.get('totalBytes'), 293216)
        self.assertEqual(report_data.get('totalFrozenFiles'), 13)
        self.assertEqual(report_data.get('totalFrozenBytes'), 23040)
        self.assertEqual(report_data.get('totalStagingFiles'), 154)
        self.assertEqual(report_data.get('totalStagingBytes'), 270176)
        ...
        self.assertEqual(project_data.get('totalFiles'), 77)
        self.assertEqual(project_data.get('totalBytes'), 135088)
        self.assertEqual(project_data.get('totalFrozenFiles'), 13)
        self.assertEqual(project_data.get('totalFrozenBytes'), 23040)
        self.assertEqual(project_data.get('totalStagingFiles'), 64)
        self.assertEqual(project_data.get('totalStagingBytes'), 112048)
        ...
        self.assertEqual(project_data.get('totalFiles'), 90)
        self.assertEqual(project_data.get('totalBytes'), 158128)
        self.assertEqual(project_data.get('totalFrozenFiles'), 0)
        self.assertEqual(project_data.get('totalFrozenBytes'), 0)
        self.assertEqual(project_data.get('totalStagingFiles'), 90)
        self.assertEqual(project_data.get('totalStagingBytes'), 158128)
        self.assertIsNone(project_data.get('maxDataAgeInDays'))
        self.assertIsNone(project_data.get('frozenFiles'))
        self.assertIsNone(project_data.get('stagingFiles'))
        ...
        self.assertEqual(lines[1].rstrip('\n'), 'ALL,293216,167,23040,13,270176,154')
        self.assertEqual(lines[2].rstrip('\n'), 'test_project_b,158128,90,0,0,158128,90')
        self.assertEqual(lines[3].rstrip('\n'), 'test_project_a,135088,77,23040,13,112048,64')
